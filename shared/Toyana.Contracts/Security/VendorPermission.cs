...
public record struct VendorPermission
{
    ...
    public static VendorPermission Create(string value)
    {
        return new VendorPermission(value);
    }

    // Implicit conversion for ease of use in attributes/claims
    public static implicit operator string(VendorPermission permission)
    {
        return permission.Value;
    }

    public static implicit operator VendorPermission(string value)
    {
        return new VendorPermission(value);
    }
