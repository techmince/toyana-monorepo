...
<div class="flex min-h-screen items-center justify-center bg-muted/50">
    <Card.Root class="w-full max-w-md">
        <Card.Header>
            ...
            <Card.Description class="text-center">Login to your Toyana account</Card.Description>
        </Card.Header>
        <Card.Content>
        ...
        <Card.Footer class="justify-center">
            <p class="text-sm text-muted-foreground">
                Don't have an account? <a href="/register" class="underline text-primary">Sign Up</a>
            </p>
        </Card.Footer>
    </Card.Root>
</div>
